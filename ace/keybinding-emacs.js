ace.define("ace/keyboard/emacs", ["require", "exports", "module", "ace/lib/dom", "ace/keyboard/hash_handler", "ace/lib/keys"], function (a, b, c) {
    var d = a("../lib/dom"), e = function (a, b) {
        var c = this.scroller.getBoundingClientRect(), e = Math.floor((a + this.scrollLeft - c.left - this.$padding - d.getPageScrollLeft()) / this.characterWidth), f = Math.floor((b + this.scrollTop - c.top - d.getPageScrollTop()) / this.lineHeight);
        return this.session.screenToDocumentPosition(f, e)
    }, f = a("./hash_handler").HashHandler;
    b.handler = new f;
    var g = !1;
    b.handler.attach = function (a) {
        g || (g = !0, d.importCssString("            .emacs-mode .ace_cursor{                border: 2px rgba(50,250,50,0.8) solid!important;                -moz-box-sizing: border-box!important;                box-sizing: border-box!important;                background-color: rgba(0,250,0,0.9);                opacity: 0.5;            }            .emacs-mode .ace_cursor.ace_hidden{                opacity: 1;                background-color: transparent;            }            .emacs-mode .ace_cursor.ace_overwrite {                opacity: 1;                background-color: transparent;                border-width: 0 0 2px 2px !important;            }            .emacs-mode .ace_text-layer {                z-index: 4            }            .emacs-mode .ace_cursor-layer {                z-index: 2            }", "emacsMode")), a.renderer.screenToTextCoordinates = e, a.setStyle("emacs-mode")
    }, b.handler.detach = function (a) {
        delete a.renderer.screenToTextCoordinates, a.unsetStyle("emacs-mode")
    };
    var h = a("../lib/keys").KEY_MODS, i = {C: "ctrl", S: "shift", M: "alt"};
    ["S-C-M", "S-C", "S-M", "C-M", "S", "C", "M"].forEach(function (a) {
        ...
        a.split("|").forEach(function (a) {
            a = a.toLowerCase(), c[a] = b, a = a.split(" ")[0], c[a] || (c[a] = "null")
        }, this)
        ...
        a.universalArgument = !1, f && (c = f + c), a.keyChain && (c = a.keyChain += " " + c);
        var h = this.commmandKeyBinding[c];
        a.keyChain = h == "null" ? c : "";
        if (!h)return;
        if (h == "null")return {command: "null"};
        if (h == "universalArgument")return a.universalArgument = !0, {command: "null"};
        if (typeof h != "string") {
            var j = h.args;
            h = h.command
        }
        typeof h == "string" && (h = this.commands[h] || a.editor.commands.commands[h]), !h.readonly && !h.isYank && (a.lastCommand = null);
        if (a.count) {
            var g = a.count;
            return a.count = 0, {
                args: j, command: {
        ...
        selectRectangularRegion: function (a) {
            ...
            exec: function (a, c) {
                a.clearSelection(), c == "left" ? a.selection.selectWordLeft() : a.selection.selectWordRight();
            ...
            var c = a.getSelectionRange(), d = a.session.getTextRange(c);
            ...
            a.undo(), a.onPaste(b.killRing.rotate()), a.keyBinding.$data.lastCommand = "yank"
        }, killRegion: function (a) {
            b.killRing.add(a.getCopyText()), a.cut()
        }, killRingSave: function (a) {
            b.killRing.add(a.getCopyText())
        }
    });
    var j = b.handler.commands;
    j.yank.isYank = !0, j.yankRotate.isYank = !0, b.killRing = {
        $data: [], add: function (a) {
